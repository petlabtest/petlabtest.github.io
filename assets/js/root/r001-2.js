"use strict";var mitllClearAll=function(a){var s=".view-filters";function l(e){a("body").hasClass("path-search")||(e.preventDefault(),a(s+" [type=hidden]").val("All"),a(s+" [type=text]").val(""),a(s+" [type=checkbox]").prop("checked",!1),function(){for(var e=a(s+" select"),l=0;l<e.length;l++)e[l].selectedIndex=0;e.change()}())}Drupal.behaviors.mitll_clearall={attach:function(e){a(".link-clear-all",e).on("click",l),a(".view").hasClass("view-clearall")?a(".views-exposed-form").addClass("views-exposed-form--has-active-filters"):a(".views-exposed-form").removeClass("views-exposed-form--has-active-filters")}}};mitllClearAll(jQuery);
